...
SPDLOG_INLINE int utc_minutes_offset(const std::tm &tm) {
    ...
    (!defined(__APPLE__) && !defined(_BSD_SOURCE) && !defined(_GNU_SOURCE) && (!defined(_POSIX_VERSION) || (_POSIX_VERSION < 202405L)))
...
SPDLOG_INLINE bool is_color_terminal() SPDLOG_NOEXCEPT {
    ...
    static const bool result = []() {
        ...
        static constexpr std::array<const char *, 16> terms = {{"ansi", "color", "console", "cygwin", "gnome", "konsole", "kterm", "linux", "msys", "putty",
                                                                "rxvt", "screen", "vt100", "xterm", "alacritty", "vt102"}};
